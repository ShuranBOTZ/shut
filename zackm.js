...
sendOrder(m.chat, teks, "391028153034238", fs.readFileSync('./media/image/mans.jpg'), 2022, "ShuranBOTZ-MD", "6281271010619@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
m.reply("Jangan maenin hidetag kintil!")
...
status: 1,
surface : 1,
message: 'sнuʀᴀɴʙoтz', //Kasih namalu
orderTitle: 'Bang',
...
"groupName": "ShuranBOTZ Broadcast", 
"caption": "ShuranBOTZ Broadcast", 
'jpegThumbnail': log0
}
}
}
...
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/pornhub-style-logo-online-generator-free-977.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'pornhub') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/pornhub-style-logo-online-generator-free-977.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'BlackMetal') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/black-metal-text-effect-829.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'GreenNeon') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/green-neon-text-effect-874.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'TiktokGlith') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === '3DAvenger') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'ArtisticGraphy') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/create-artistic-typography-online-1086.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'ViGame') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/video-game-classic-8-bit-text-effect-1037.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'pencil') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/create-a-sketch-text-effect-online-1044.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'batman') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/make-a-batman-logo-online-free-1066.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
...
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'BWBear') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/online-black-and-white-bear-mascot-logo-creation-1012.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'cloud') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/create-a-cloud-text-effect-in-the-sky-online-997.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'window') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/write-text-on-foggy-window-online-free-1015.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'Helowen') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/create-scary-halloween-text-effects-online-1090.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'metalic') {
if (args.length < 2) return m.reply(`Example :\n${prefix + command + ' ' + args[0]} 𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳`)
let teds = await thiccysapi.textpro("https://textpro.me/create-a-metallic-text-effect-free-online-1041.html", [args[1]])
mans.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
...
m.reply('Masih Ada Pertanyaan Yang Belum Diselesaikan!')
throw false
}
...
if (sizny < 20) {
teks = `Maaf anggota group anda kurang dari 20, minimal agar bot join harus mempunyai lebih dari 50 anggota`
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./media/image/mans.jpg'), 2022, "𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳", "6281271010619@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 20) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
case 'nulis': {
if (isBan) return m.reply(mess.ban)
if (args.length < 1) return m.reply(`Example :\n${prefix}nulis MyMainas|91|#ff020a|Manusia terganteng adalah Suranta AD`)
const nls = args.join(" ")
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳 - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳 - Facebook Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"𝚂𝙷𝚄𝚁𝙰𝙽𝙱𝙾𝚃𝚉-𝙼𝙳 - Tiktok Downloader",
